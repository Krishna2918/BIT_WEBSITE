  ...
  return (
    <section id="sectors" className="cover-wrap">
      <div className="cover-reel-copy">
        ...
        <h2 className="text-center text-[clamp(1.55rem,5.2vw,2.75rem)] font-semibold tracking-[-0.03em] text-ink">
          One team. Every kind of floor.
        </h2>
        <p className="mx-auto mt-2 max-w-xl px-1 text-center text-[15px] leading-snug text-muted sm:text-[16px]">
