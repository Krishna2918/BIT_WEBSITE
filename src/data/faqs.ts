...
/** Questions from bitsolution.ca. Answers use only locked BIT facts. */
export const FAQS: Faq[] = [
  ...
  },
  {
    ...
    a: "24/7 on +1 905-867-6574 or WhatsApp at the same number. Email support@bitsolution.ca. Raise a ticket from Help — short form or Ask AI. A person picks up when it is a person problem.",
  },
  {
