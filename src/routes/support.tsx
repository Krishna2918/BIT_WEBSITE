  ...
  head: () => ({
    ...
    meta: [
      { title: "Support — BIT Solution" },
      {
        name: "description",
        content:
          "24/7 BIT Solution support across Ontario. Call or WhatsApp +1 905-867-6574. Raise a ticket at /ticket.",
      },
    ],
  }),
});
  ...
  return (
    <main className="bg-bg">
      ...
      <section className="mx-auto grid max-w-3xl gap-3 px-5 pb-16 sm:grid-cols-2">
        ...
        >
          <p className="support-kicker">IT ticket</p>
          <h2>Raise a ticket</h2>
          <p>Company, work email, and what broke. Do not send passwords.</p>
        </Link>
      </section>
